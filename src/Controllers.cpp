...
Controllers::Controllers(XrInstance instance, XrSession session)
    : session(session)
{
    ...
    interactionProfileSuggestedBinding.interactionProfile = util::stringToPath(instance, "/interaction_profiles/khr/simple_controller");
